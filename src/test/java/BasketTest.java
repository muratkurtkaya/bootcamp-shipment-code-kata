...
import com.trendyol.shipment.BasketEmptyException;
...
class BasketTest {
    ...
    void shouldGetOrderShipmentSizeAsExpected(List<ShipmentSize> shipmentSizesOfProducts, ShipmentSize orderShipmentSize) throws BasketEmptyException {
    ...
    @Test
    void shouldThrowBasketEmptyExceptionWhenBasketIsEmpty() {
